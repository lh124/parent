...
var vm = new Vue({
    ...
    methods: {
        query: function () {
            ...
            vm.updateDate();
            $.ajax({
                url: "../childrenOfAllAgeGroups/queryJiankaChilBirthHospital",
                type: "POST",
                data: {"startDate": year, "endDate": month},
        ...
        excel: function () {
            ...
            window.open("../childrenOfAllAgeGroups/queryJiankaChilBirthHospital/export?startDate=" + yearDate + "&endDate=" + monthDate + "&page=1&limit=10000&time=" + new Date());
        },
        print: function () {
            //设置打印时样式
            vm.updateDate();
        ...
        updateDate: function () {
            ...
            $("#startData").html(yearDate);
            $("#endData").html(monthDate);
        },
        //行政村
