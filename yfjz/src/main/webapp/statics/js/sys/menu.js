...
var vm = new Vue({
	...
	data:{
		...
		menu:{
			parentName:null,
			parentId:'7ccf4b5f-8bd0-11e8-aec8-54e1ad773d4d',
			type:1,
			orderNum:0
		}
	},
	methods: {
		...
		add: function(){
			vm.showList = false;
			vm.title = "新增";
			vm.menu = {parentName:null,parentId:'7ccf4b5f-8bd0-11e8-aec8-54e1ad773d4d',type:1,orderNum:0};
			vm.getMenu();
		},
