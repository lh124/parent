...
/**
 * @class_name: FileUploadServlet
 * @describe: 本servlet支持多中文件格式的文件上传
 * 注： "zip","ico", "jpeg", "jpg", "png", "gif", "bmp",
 * 		"txt", "doc", "docx", "xls", "xlsx", "ppt",
 * 		"pptx", "pdf", "ico", "jpeg", "jpg", "png",
 * 		"gif", "bmp","rar"
 * @author: 刘琪
...
public class FileUploadServlet extends HttpServlet {
	...
	private static final long FILESIZE = 20 * 1024 * 1024;// 文件大小20M设置
	private static final String[] fileTypeArr = { "zip","ico", "jpeg", "jpg", "png", "gif", "bmp",
			"txt", "doc", "docx", "xls", "xlsx", "ppt", "pptx", "pdf", "ico", "jpeg", "jpg", "png",
			"gif", "bmp","rar"};
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			e.printStackTrace();
			logger.info("您所选择的文件大于10M，请选择小于10M的文件上传");
			response.getWriter().print(new JsonResult(-1, "您所选择的文件大于10M，请选择小于10M的文件上传").toString());
			return;
		} catch (Exception e) {
			e.printStackTrace();
